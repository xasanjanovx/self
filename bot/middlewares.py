...
async def _setup_new_member(user) -> str:  # noqa: ANN001
    """Первый вход по приглашению: профиль, язык бота и JES — по языку его Telegram."""
...
WELCOME = {
    "ru": ("👋 <b>Добро пожаловать!</b>\n\nЭто личный помощник с ИИ «JES». Просто пиши или говори голосом, как человеку:\n"
           "• «такси 25 000», «обед 40к» — расходы\n• фото еды — калории\n• «напомни завтра в 9 позвонить маме»\n"
           "• «накопить 5 млн к декабрю» — цели\n• 🤖 JES — звонок, будильник, голос\n\n"
           "Все твои данные видишь только ты.\n\n📞 JES написал тебе из своего аккаунта — добавь его в контакты, чтобы его звонки доходили."),
    "uz": ("👋 <b>Xush kelibsiz!</b>\n\nBu sun'iy intellektli shaxsiy yordamchi — «JES». Odamga yozgandek yozing yoki ovozli gapiring:\n"
           "• «taksi 25 000», «tushlik 40k» — xarajatlar\n• ovqat rasmi — kaloriya\n• «ertaga 9 da onamga qo'ng'iroq qilishni eslat»\n"
           "• «dekabrgacha 5 mln yig'ish» — maqsadlar\n• 🤖 JES — qo'ng'iroq, budilnik, ovoz\n\n"
           "Ma'lumotlaringizni faqat siz ko'rasiz.\n\n📞 JES o'z akkauntidan sizga yozdi — qo'ng'iroqlari kelishi uchun uni kontaktlarga qo'shing."),
    "en": ("👋 <b>Welcome!</b>\n\nThis is your personal AI assistant, JES. Just write or speak to it like to a person:\n"
           "• “taxi 25 000”, “lunch 40k” — expenses\n• a food photo — calories\n• “remind me tomorrow at 9 to call mom”\n"
           "• “save 5 mln by December” — goals\n• 🤖 JES — calls, alarm, voice\n\n"
           "Only you can see your data.\n\n📞 JES has messaged you from its own account — add it to your contacts so its calls come through."),
}
