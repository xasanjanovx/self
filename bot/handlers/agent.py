...
_COMMAND_HINTS = (
    ...
    "вес ", "взвесил", "весил", "вешу", "vazn", "сделал", "сходил", "пробежал", "отметь", "qildim", "bordim", "цель", "maqsad", "сэконом", "не больше", "процент", "%",
...
def system_prompt(profile: Profile, snapshot: str, memory: str = "") -> str:
    ...
    return (
        ...
        "подъём на фаджр со звонком в Telegram, времена намаза (Андижан), аят и хадис дня; "
        ...
        "«разбуди за 30 минут до такбира» / «буди в 6:30» / «по будням» / «не звони неделю» / «жёстче» → set_wake. "
        ...
        "17б. Аят дня — daily_verse: узбекский перевод Муҳаммад Содиқ Муҳаммад Юсуфа, его можно давать как есть. Хадис оттуда же идёт по-русски "
        "с номером (Бухорий 1) — на узбекский переводишь ТЫ, и обязан пометить: «tarjima — mening» (мой перевод), источник и номер указывай всегда. "
        "Никогда не сочиняй хадисы и не приписывай Пророку ﷺ слова, которых нет в присланном тексте; не знаешь — скажи прямо.\n"
