...
ID_SETTINGS = "5877260593903177342"   # ⚙ TgAndroidIcons
...
ID_GOAL = "5961051261204696786"       # 🥇 TgAndroidIcons
ID_TASKS = "5985596818912712352"      # ✅ (задачи)
ID_PERIOD = "5967782394080530708"     # 📅
ID_JARVIS = "5985780596268339498"     # 🤖 (робот с искрами — ИИ-помощник)
# главное меню — только из его паков (TgAndroidIcons / SoLo_HaMiD / adaptiveqp_by_emsetbot), 26.09.2026
ID_ALARM = "5985616167740379273"      # ⏰ TgAndroidIcons
