...
Результат идёт в системный промпт Nurai, в утреннюю сводку и в советы по целям
...
def prompt_lines(meals: dict[str, Any], spending: dict[str, Any], lang: str = "ru") -> list[str]:
    """Строки для системного промпта Nurai: что человек обычно ест и на что тратит."""
    out: list[str] = []
