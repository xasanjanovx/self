"""Telegram от имени владельца (его личный аккаунт) — для голосового Джарвиса на телефоне.

Бот и аккаунт-помощник «Джарвис» не могут писать маме от лица пользователя, поэтому здесь
