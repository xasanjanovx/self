"""Telegram от имени владельца (его личный аккаунт) — для голосового JES на телефоне.

Бот и аккаунт-помощник «JES» не могут писать маме от лица пользователя, поэтому здесь
