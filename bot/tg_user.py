"""Telegram от имени владельца (его личный аккаунт) — для голосового ZEKI на телефоне.

Бот и аккаунт-помощник «ZEKI» не могут писать маме от лица пользователя, поэтому здесь
