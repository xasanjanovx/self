"""Бесплатный голос Джарвиса: нейроголоса Microsoft (Edge «Прочитать вслух», библиотека edge-tts).

Он выбрал (25.09.2026) вместо платного TTS Gemini в экономном режиме телефона: бесплатно, фраза готова за 0.3–0.7 с,
есть русский (Светлана), узбекский (Мадина) и английский. Язык — по самому тексту ответа (Джарвис отвечает на языке
