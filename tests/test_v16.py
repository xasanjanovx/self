...
@pytest.mark.parametrize("text, after", [
    ("зеки", ""),
    ("эй зеки", ""),
    ("зеке позвони маме", "позвони маме"),
    ("эйзеки", ""),
    ("зики какая погода завтра", "какая погода завтра"),
    ("зэки открой ютуб", "открой ютуб"),
    ("зыкий колейзен", "колейзен"),
    ("zeki open", "open"),
    ("зи кей what time", "what time"),
])
...
@pytest.mark.parametrize("text", [
    "реки текут", "веки тяжёлые", "зайки мои", "заки позвонил", "закиров пришёл", "секи время", "сики", "звонки пропущены",
    "зеркало", "зачем", "бугун хаво джуда яхщи", "",
    # прежние имена больше не будят (он просил: только ZEKI)
    "джарвис", "эй джарвис позвони маме", "нурай", "ну рай", "nurai",
])
